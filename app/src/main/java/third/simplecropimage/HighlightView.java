...
class HighlightView {
    ...
    protected void draw(Canvas canvas) {
		...
		mOutlinePaint.setColor(0xFFFF8A00);    
            ...
            if (mMode == ModifyMode.Grow) {
                if (mCircle) {
                    int width = mDrawableDiagonal.getIntrinsicWidth();
                    int height = mDrawableDiagonal.getIntrinsicHeight();
                    ...
                    mDrawableDiagonal.setBounds(x, y,
                            x + mDrawableDiagonal.getIntrinsicWidth(),
                            y + mDrawableDiagonal.getIntrinsicHeight());
                    mDrawableDiagonal.draw(canvas);
                } else {
                    ...
                    int widthWidth =
                            mDrawableWidth.getIntrinsicWidth() / 2;
                    int widthHeight =
                            mDrawableWidth.getIntrinsicHeight() / 2;
                    int heightHeight =
                            mDrawableHeight.getIntrinsicHeight() / 2;
                    int heightWidth =
                            mDrawableHeight.getIntrinsicWidth() / 2;
                    ...
                    mDrawableWidth.setBounds(left - widthWidth,
                            yMiddle - widthHeight,
                            left + widthWidth,
                            yMiddle + widthHeight);
                    mDrawableWidth.draw(canvas);

                    mDrawableWidth.setBounds(right - widthWidth,
                            yMiddle - widthHeight,
                            right + widthWidth,
                            yMiddle + widthHeight);
                    mDrawableWidth.draw(canvas);

                    mDrawableHeight.setBounds(xMiddle - heightWidth,
                            top - heightHeight,
                            xMiddle + heightWidth,
                            top + heightHeight);
                    mDrawableHeight.draw(canvas);
    ...
    private Drawable mDrawableWidth;
    private Drawable mDrawableHeight;
    private Drawable mDrawableDiagonal;

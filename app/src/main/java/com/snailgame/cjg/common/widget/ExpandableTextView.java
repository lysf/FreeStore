...
public class ExpandableTextView extends RelativeLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getResources().getDrawable(R.drawable.app_detail_extend_down);
        }
        if (mCollapseDrawable == null) {
//            mCollapseDrawable = getResources().getDrawable(R.drawable.ic_extend_up);
        }
    ...
    private void findViews() {
        ...
        if (mTv == null)
            mTv = (TextView) findViewById(R.id.second_expandable_text);

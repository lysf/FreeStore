 ...
 * 管理页面百宝箱Adapter
 */
public class CommunicationChildGridApdapter extends BaseAdapter {
    private Activity activity;
    private List<CommunicationChildContentModel> dataList;

    public CommunicationChildGridApdapter(Activity activity, List<CommunicationChildContentModel> dataList) {
    ...
    @Override
    public CommunicationChildContentModel getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(FreeStoreApp.getContext()).inflate(
                    R.layout.fragment_communication_quick_view_item, parent, false);
        ...
        CommunicationChildContentModel communicationChildContentModel = getItem(position);
        if (communicationChildContentModel != null) {
            if (!TextUtils.isEmpty(communicationChildContentModel.getsJumpUrl())) {
            ...
            String title = communicationChildContentModel.getsTitle();
            String url = communicationChildContentModel.getsImageUrl();

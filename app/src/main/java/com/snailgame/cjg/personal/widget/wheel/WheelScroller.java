...
public class WheelScroller {
    ...
    // animation handler
    private Handler animationHandler = new MsgHandler(this);

    static class MsgHandler extends Handler {
        private WeakReference<WheelScroller> mView;

        public MsgHandler(WheelScroller view) {
            this.mView = new WeakReference<WheelScroller>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            WheelScroller view = mView.get();
            if (view != null) {
                view.animationView(msg);
            }
        }
    }

    private void animationView(Message msg) {
